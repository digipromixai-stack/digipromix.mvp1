  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // backgrounds throughout the dashboard, competitor, and campaign
        // layouts) — indigo hue, not the emerald one from the reference mockup.
        'primary-container': '#E2DFFF',
        'on-primary-container': '#3323CC',
        secondary: '#585f6c',
        'surface-main': '#F9FAFB',
        'surface-card': '#FFFFFF',
      ...
      backgroundImage: {
        'gradient-brand':    'linear-gradient(135deg, #3525cd 0%, #4f46e5 100%)',
